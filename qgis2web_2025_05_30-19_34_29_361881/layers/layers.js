...
lyr_OSMStandard_0.setVisible(true);lyr_building_house_1.setVisible(true);lyr_highway_2.setVisible(true);lyr_highway_3.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_building_house_1,lyr_highway_2,lyr_highway_3];
lyr_building_house_1.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'building': 'building', 'height': 'height', 'roof:colour': 'roof:colour', 'building:levels': 'building:levels', 'addr:street': 'addr:street', 'addr:housenumber': 'addr:housenumber', 'addr:city': 'addr:city', 'address': 'address', });
lyr_highway_2.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'noexit': 'noexit', 'public_transport': 'public_transport', 'name': 'name', 'bus': 'bus', 'shelter': 'shelter', 'bench': 'bench', 'motorcycle': 'motorcycle', 'motorcar': 'motorcar', 'horse': 'horse', 'hgv': 'hgv', 'foot': 'foot', 'bicycle': 'bicycle', 'barrier': 'barrier', });
...
lyr_building_house_1.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'building': 'TextEdit', 'height': 'TextEdit', 'roof:colour': 'TextEdit', 'building:levels': 'TextEdit', 'addr:street': 'TextEdit', 'addr:housenumber': 'TextEdit', 'addr:city': 'TextEdit', 'address': '', });
lyr_highway_2.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'noexit': '', 'public_transport': '', 'name': '', 'bus': '', 'shelter': '', 'bench': '', 'motorcycle': '', 'motorcar': '', 'horse': '', 'hgv': '', 'foot': '', 'bicycle': '', 'barrier': '', });
...
lyr_building_house_1.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'building': 'no label', 'height': 'no label', 'roof:colour': 'no label', 'building:levels': 'no label', 'addr:street': 'no label', 'addr:housenumber': 'no label', 'addr:city': 'no label', 'address': 'no label', });
lyr_highway_2.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'noexit': 'no label', 'public_transport': 'no label', 'name': 'no label', 'bus': 'no label', 'shelter': 'no label', 'bench': 'no label', 'motorcycle': 'no label', 'motorcar': 'no label', 'horse': 'no label', 'hgv': 'no label', 'foot': 'no label', 'bicycle': 'no label', 'barrier': 'no label', });
lyr_highway_3.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'smoothness': 'no label', 'sidewalk:both': 'no label', 'lit': 'no label', 'lanes:forward': 'no label', 'lanes:backward': 'no label', 'lanes': 'no label', 'covered': 'no label', 'maxspeed': 'no label', 'access': 'no label', 'name:uk': 'no label', 'int_name': 'no label', 'name:ru': 'no label', 'name:etymology:wikidata': 'no label', 'name:en': 'no label', 'name': 'no label', 'surface': 'no label', 'description': 'no label', });
